...
void encontrarMediana(AVLTree& arbol) {
    ...
    arbol.inOrden(elementos); // Llamar correctamente a la función inOrden
    ...
    if (n % 2 == 1) {
        cout << "La mediana es: " << elementos[n / 2] << endl;
    } else {
        double mediana = (elementos[n / 2 - 1] + elementos[n / 2]) / 2.0;
...
int main() {
    AVLTree arbol;
    ifstream archivo("in_01.txt"); // Cambia el nombre del archivo según corresponda
    string operacion;
    int valor;
